            ...
            <table class="frmtbl">
                ...
                <tr border="1" class="hdrow">
                  ...
                  <tr>
                    ...
                    <td colspan="3"> <input type="text" id="uphn1" name="uphn1" placeholder="Mobile No." required="true" VT="PH">
                    <font style="font-family: Verdana;">Are You Medically Fit</font>
                    <input type="text" id="uphn2" name="uphn2" placeholder="Yes or No" required="true" VT="PH"></td>
                  </tr>
                ...
                <tr>
                    ...
                    <td> <input type="text" id="umocc" name="umocc" required="true" VT="NM"> </td>
                     <td> <font style="font-family: Verdana;">Weight & Height</font></td>
                    <td> <input type="text" id="umphn" name="umphn" required="true" placeholder="like KGx45inch" VT="PH"></td>
                </tr>
                ...
                <tr>
                 ...
                 <tr>
                    <td><font style="font-family: Verdana;">Game Name</font></td>
                    <td><select id="oaco" name="oaco" required>
                            <option>--------------------Select--------------------</option>
                            <option>KARATE</option>
                            <option>WUSHU</option>
                            <option>MIX MARTIAL ARTS</option>
                            <option>SELF DEFENCE</option>
                    ...
                    <td><font style="font-family: Verdana;">Birth Place</font></td>
               ...
               <tr>
                     ...
                     <td><input type="text" id="col" name="col" required="true"></td>
                ...
                <tr>
                     <td><font style="font-family: Verdana;">Present Belt Grade</font></td>
