...
?>
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 <td style="width:3%;"><img src="images/Logo-T.JPG" width="80%"> </td>
                 <td style="width:8%;"><center>
                 <font style="font-family:Arial Black; font-size:20px;">
                    MASTER SONU MARTIAL ARTS & BODY FITNESS ACADEMY</font>
                    <font style="font-family:Arial Black; font-size:20px;">
                    Affiliated to:Institute Of Martial Arts India</font>
                    <font style="font-family:Arial Black; font-size:20px;">
                    Website: www.master-sonu.com : Email : fightersonusah@gmail.com</font>
                 </center>
                
                <center><font style="font-family:Verdana; font-size:18px;">
                    Mob. : +91 9507735233, 9939777151
                    </font></center>
                
                <br>
                <br>
                <center><font style="font-family:Arial Black; font-size:20px;">
                    ADMISSIONS (2020-21)</font></center>
                </td>
