...
<html>
    ...
    <body>
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 <td style="width:3%;"><br><br><img src="./images/Logo-T.jpg" width="50%"> </td>
                 <td style="width:8%;"><center><font style="font-family:Arial Black; font-size:20px;">
                     <br><br>
                    MARTIAL ARTS BODY FITNESS ACADEMY</font></center>
                
                <center>
                  <font style="font-family:Verdana; font-size:18px;">
                    MOB.NO. : +91 9507735233, +91 9939777151 
                    </font></center>
                ...
                <tr>
                  ...
                  <tr>
                    <td > <font style="font-family: Verdana;"> Mobile No.</font><br>
                    <font style="font-family: Verdana;">Are You Medically Fit</font>  </td>
                    <td colspan="3"> <?php echo 'Mobile No. - '. $row[2]. '   ' ?><br>
                    <?php echo $row[3] ?></td>
                  </tr>
                ...
                <tr>
                    <td height="39"> <font style="font-family: Verdana;">Mother's Occupation</font></td>
                ...
                <tr>
                 ...
                 <tr>
                    <td><font style="font-family: Verdana;">Game Appeared</font></td>
                    <td><?php echo $row[24] ?>
                   ...
                   <td colspan="3">
                       <table class="table table-hover">
                           ...
                           <center><font style="font-family: Verdana;">Signature</font></center> 
                               ...
                               <!--<td colspan="2"><?php echo $row[47] ?></td>-->
                           </tr>
