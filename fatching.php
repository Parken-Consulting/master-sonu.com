...
<h3 align="center" style="color:#F1F002">****SIWAN STUDENT REGISTRATION DETAILS****</h3></div>

 <!--dyanemic gallary-->
<?php
	$sql="SELECT * FROM done2";
...
<td><b>PHOTO</b></td>
        ...
        <td width="135"><img src="dbwork/siwan/<?php echo $row["photo"]?>" width="135" height="150"></td>  
        </tr></marquee></table>
              <?php
	}
			?>
